...
import { getGenderLabel } from '../../features/Person/models';
...
function InsuranceFormGender() {
  ...
  return (
    <AppPage>
      ...
      <ProfilePanel profile={profile} fixed="gender" />
...
export default InsuranceFormGender;
